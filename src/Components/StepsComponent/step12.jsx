        ...
        <>
            ...
            <div className='componentBoxSizingStep10 mx-auto box-border rounded-2xl bg-white w-11/12 md:w-2/4'>
                <div className='flex flex-wrap justify-center items-center text-center mt-5 pb-5 md:mt-24 md:pb-10 '>
                    <h2 className='mx-auto step2Text'>Thanks Ali, your quote is ready! Where do we send it to?</h2><br></br>
                </div>
                ...
                <div className="flex flex-row justify-center items-center  w-full ">
                    <button onClick={showStep11} className="flex step10Btn justify-center text-center items-center focus:outline-none mt-6">Next</button>
                </div>
